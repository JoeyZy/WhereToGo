...
CREATE TABLE `events` (
  ...
  CONSTRAINT `fk_categories` FOREIGN KEY (`categories`) REFERENCES `categories` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `users` VALUES (1,'Te','te','te','te'),(2,'q','q','q','q'),(3,'z','z','z','z'),(4,'z','z','z','z'),(5,'x','x','x','x'),(6,'v','v','v','v'),(7,'x','x','x','x');
