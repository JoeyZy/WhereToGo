...
public class CategoryRepository extends AbstractRepository<Category> {
	...
	private Category getMovieCategory() {
		...
		Event kapitoshka = new Event(0, "Kapitoshka", "Капітошка — літературний персонаж, який був створений письменницею і сценаристом Наталею Гузеєвою, герой мультиплікаційних фільмів та дитячих книг. Художній образ Капітошки був втілений художником Генріхом Уманським.\n" +
				"\n" +
				...
				"\n" +
				"Друга серія, яка була випущена у 1989 році, розповідає про те, як Вовченя очікує на Капітошку, а також про те, як до нього навідується його зла тітонька. Вовченя намагалося їй пояснити, що не хоче бути злим вовком, таким, як вона. Тут з'являється Капітошка і разом з Вовченям вони проганяють тітку.", organizer, comers);
